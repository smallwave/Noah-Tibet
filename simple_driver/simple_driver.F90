...
#define _SIMPLE_DRIVER_ 
  ...
  ! wuxb add Soil Heterogeneity Horzoin   2015.9.30
  ...
  ! STYPE            -- Soil Horizon Type. A pointer array allocated within subroutine open_forcing_file    wuxb add 2015.9.30
  ...
  !wuxb add stype Parameters 2015.9.30 
