...
class NcFileProcess(object):
    ...
    # input 
    # update globe
    def getNcDataByDay(self,varName,nLayer,varTimeDataArray,startTime = None, endTime = None):
    ...
    #2016.8.3  getAllLayerMeanTempByMonth
    def getAllLayerMaxMinTempByDay(self,delLayerNum,varTimeDataArray,startTime = None, endTime = None,):
        if startTime is None:
            startTime = datetime.datetime(2010,1,1)
        if endTime is None:
            endTime   = datetime.datetime(2010,12,31)
    ...
    #2016.9.12 
    def getAllLayerMeanTempByYearMonth(self,delLayerNum,varTimeDataArray,startTime = None, endTime = None,):
        if startTime is None:
            startTime = datetime.datetime(2010,1,1)
        if endTime is None:
            endTime   = datetime.datetime(2010,12,31)
        ...
        for i in range(0,dimsSoilLayer-delLayerNum):
            ...
            #clip by sele data
            resListLayer         =  groupVarSelDataMean['Temp'].values.tolist()
            allLayerList.append(resListLayer)
        return allLayerList
